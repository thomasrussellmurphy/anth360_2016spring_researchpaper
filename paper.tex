...
% Set smaller section title size
% Am only using \section* in this document
\usepackage{titlesec}
...
\usepackage[pdftex,
            ...
            pdfsubject={},
            pdfkeywords={abortion, training, medical training, OB/GYN, obstetrician, gynecology, reproduction, fertility, healthcare},
...
Even though a Cesarean is a more complex prodedure than an abortion, it is distinctly more accepted and has not generated the same controversy, despite its higher frequency.
...
In different cases, prochoice physicians make effort to avoid the topic in the professional setting and there is anecdotal evidence that practices have split due to differing views on abortion. \autocite[pg. 149]{freedman_obstacles_2010}
